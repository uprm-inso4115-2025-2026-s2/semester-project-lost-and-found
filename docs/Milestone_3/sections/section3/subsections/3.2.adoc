...
[.added]#The diagram below shows execution steps and decision points, not just the stakeholders or reports involved.#

image::SystemOperationDiagram.png[System Operation Diagram, align=center, pdfwidth=80%]
_Figure: System Operation Diagram - Illustrating the execution flow of validation scenarios, including user actions, system responses, and decision points._
...
| [[TEST-REPORT-01]]TEST-REPORT-01 — Submit valid report
a|
- <<REQ-REPORT-F-01>>
- <<REQ-REPORT-F-03>>
- <<IR001>>
...
| [[TEST-REPORT-02]]TEST-REPORT-02 — Edit own report
a|
- <<REQ-REPORT-F-03>>
- <<IR005>>
| Changes saved
...
| [[TEST-REPORT-03]]TEST-REPORT-03 — Edit as other user (active report)
a|
- <<REQ-REPORT-F-03>>
- <<REQ-CLAIM-F-01>>
- <<IR009>>
...
| [[TEST-REPORT-04]]TEST-REPORT-04 — Submit found report
a|
- <<REQ-REPORT-F-02>>
- <<REQ-REPORT-F-04>>
- <<IR002>>
...
| [[TEST-REPORT-05]]TEST-REPORT-05 — Privacy handling
a|
- <<REQ-CLAIM-F-01>>
- <<REQ-REPORT-F-02>>
- <<IR004>>
...
| [[TEST-SEARCH-01]]TEST-SEARCH-01 — Search by keyword
a|
- <<REQ-SEARCH-F-01>>
- <<REQ-SEARCH-F-02>>
- <<IR014>>
...
| [[TEST-MOD-01]]TEST-MOD-01 — Flag detection
a|
- <<REQ-ADMIN-F-01>>
- <<IR018>>
...
| [[TEST-MOD-02]]TEST-MOD-02 — Visibility control
a|
- <<REQ-SEARCH-F-02>>
- <<IR015>>
...
| [[TEST-MOD-03]]TEST-MOD-03 — Author notification
a|
- <<REQ-ADMIN-F-02>>
- <<IR017>>
...
| [[TEST-MOD-04]]TEST-MOD-04 — Appeal/edit flow
a|
- <<REQ-ADMIN-F-02>>
- <<REQ-REPORT-F-01>>
- <<IR005>>
...
| [[TEST-SEARCH-02]]TEST-SEARCH-02 — Category filter
a|
- <<REQ-SEARCH-F-01>>
- <<IR015>>
...
| [[TEST-SEARCH-03]]TEST-SEARCH-03 — Keyword search
a|
- <<REQ-SEARCH-F-02>>
- <<IR014>>
- <<IR015>>
...
| [[TEST-SEARCH-04]]TEST-SEARCH-04 — No image dependency
a|
- <<REQ-REPORT-F-02>>
- <<IR002>>
...
| [[TEST-SEARCH-05]]TEST-SEARCH-05 — Sorting / filtering by status
a|
- <<REQ-SEARCH-F-02>>
- <<IR015>>
...
[.changed]#**Purpose:** Validate that the Lost & Found platform’s requirements, workflows, and system behavior match real-world expectations and stakeholder needs. Verification is handled separately through the documented test cases and implementation checks. This includes input validation, report lifecycle management, moderation workflows, access control, and search functionality.#
