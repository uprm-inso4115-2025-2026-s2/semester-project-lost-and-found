...
== 2 Requirements Acquisition (Questionnaire)
...
== 3 Elicitation Summary (Preliminary Findings)

=== 3.1 Method (Elicitation)

* Respondents: N = 10
* Stakeholder mix: 8 students, 2 staff (security)
* Collection method: Google Form 
* Dates: Mar/28/2026 - Apr/5/2026
** Small sample size
...
=== 3.3 What These Findings Support (Concrete Claims)
...
=== 3.4 Follow-up Plan (Stronger Evidence)
