...
- F1.1 Structured lost item submission
- F1.2 Structured found item submission
...
_"As a user who lost an item, I want to submit structured information about it so that others can help locate it."_
...
_"As a user who found an item, I want to describe and upload photos so that the rightful owner can identify it."_
...
_"As a user, I want to filter listings by category so that I can narrow down results."_
...
_"As a user, I want to search using keywords so that I can quickly find relevant reports."_
...
_"As a report owner, I want to mark an item as resolved so that others know it has been returned."_
